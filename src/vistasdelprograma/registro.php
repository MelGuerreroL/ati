            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input type="password" id="contraseña" name="contraseña" placeholder="Crea una contraseña" required minlength="8">
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input type="password" id="confirmar_contraseña" name="confirmar_contraseña" placeholder="Crea una contraseña" required minlength="8">
