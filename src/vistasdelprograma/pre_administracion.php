...
require_permission('config', PERM_READ);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="container">
    ...
    <div class="button-grid">
        ...
        <a href="bitacora.php" class="big-button">
            <i class="fas fa-book"></i>
            <span>Bitácora</span>
        </a>

        <a href="parametros.php" class="big-button secondary">
            <i class="fas fa-sliders-h"></i>
            <span>Parámetros</span>
        </a>

        <!-- BOTÓN NUEVO DE VOLVER AL MENÚ PRINCIPAL -->
